...
@dso_cache = dso_local local_unnamed_addr global [48 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i1 false, ; bool ignore
		i1 false, ; bool is_jni_library
		ptr @.DSOCacheEntry.6_name, ; name: libmono-component-diagnostics_tracing.so
		ptr null; void* handle
	}, ; 20
	%struct.DSOCacheEntry {
...
@dso_jni_preloads_idx = dso_local local_unnamed_addr constant [8 x i32] [
	...
	i32 26, ; System.Security.Cryptography.Native.Android
	i32 19, ; libxamarin-debug-app-helper.so
	i32 38, ; libxamarin-debug-app-helper
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [28 x i8] c"com.companyname.mygooddiary\00", align 1
...
@.DSOCacheEntry.6_name = private unnamed_addr constant [41 x i8] c"libmono-component-diagnostics_tracing.so\00", align 1
